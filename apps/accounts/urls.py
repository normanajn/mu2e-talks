...
urlpatterns = [
    ...
    path('institutions/aliases/', views.InstitutionAliasListView.as_view(), name='institution-aliases'),
    path('users/aliases/', views.UserAliasListView.as_view(), name='user-aliases'),
